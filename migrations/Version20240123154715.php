 ...
 */
final class Version20240123154715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_EED1038987B5B78 ON navire (mmsi)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_EED1038987B5B78 ON navire');
